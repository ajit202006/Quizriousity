            ...
            <div className='w-full h-full flex overflow-x-scroll [&::-webkit-scrollbar]:hidden snap-mandatory snap-x *:snap-center '>
                <section id='quiz-info' className='min-w-full h-full'>
                    <div className='h-1/3 flex flex-col relative items-center justify-center *:flex *:items-center *:justify-center'>
                        <h1 className='w-full h-3/10 text-5xl font-semibold whitespace-nowrap overflow-x-auto overflow-y-none [&::-webkit-scrollbar]:hidden' title={quiz.name}>{quiz.name}</h1>
                        <p className='text-2xl text-[#B9B9B9] font-semibold'>Created by :- <span className='max-w-xs hover:underline cursor-pointer mx-1 whitespace-nowrap overflow-x-auto [&::-webkit-scrollbar]:hidden' onClick={() => navigate(`/users/${userId}`)}>{userName}</span></p>
                    </div>
                    <hr />
                ...
                <section id='quiz-view' className='min-w-full max-h-max min-h-full font-semibold overflow-y-auto custom-scrollbar py-4 flex justify-center '>
                    <div className='w-95/100 h-max min-h-95/100 flex flex-col items-center justify-between p-4 rounded-3xl bg-quiz-view-bg text-black'>
