        ...
        return (
            <li className='w-11/12 mb-10' id={'q' + qNum} key={'q' + qNum} >
                ...
                <div className='w-full flex flex-col *:my-1.5'>
                    <h1>Options :-</h1>
                    <form className='w-11/12 flex flex-col self-center gap-2 *:max-w-9/10 *:flex *:items-center *:justify-between [&_span]:max-w-4/5 *:wrap-break-word [&_input]:custom-radio-button'>
